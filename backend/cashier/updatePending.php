<?php 
    ...
    if(isset($_POST["item_id"]) && isset($_POST["status_id"])){
        ...
        $query2 = "SELECT CONCAT(td.first_name, ' ', td.last_name) AS full_name, ac.role_id, tr.role_name FROM tbl_account ac 
        INNER JOIN tbl_role tr ON ac.role_id = tr.role_id 
        INNER JOIN tbl_account_details td ON ac.account_id = td.account_id
        Where ac.account_id = ?;";
        ...
        if($result->num_rows > 0){
            ...
            if($status_id == 2){
                ...
                transaction($conn, $cashier_id, $full_name, $role_id, $current_date, $activity, $item_id);
            }
