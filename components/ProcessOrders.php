                            ...
                            <table class="styled-table">
                                ...
                                <tbody>
                                    ...
                                    while ($data = $result->fetch_assoc()) {
                                        ...
                                        $formattedDate = date("F j, Y", strtotime($data["order_date"]));
                                        // recieve date must be 3 days after the order date and add 3 days
                                        $recieveDate = date("F j, Y", strtotime($data["order_date"] . ' + 3 days'));
                                    ?>
                                        <tr>
                                            <td>
                                                <div class="img-con">
