      ...
      <div id="layoutSidenav_content">
        <main>
            ...
            <div class="c-dashboardInfo col-xl-3 col-md-6">
              <div class="wrap">
                <h4
                  class="heading heading5 text-white hind-font medium-font-weight c-dashboardInfo__title"
                >
                <?php
                ...
                <span class='hind-font caption-12 text-white c-dashboardInfo__count'>₱<?php echo $data5["total_sales"] != 0 ? number_format($data5["total_sales"], 2) : "0.00"; ?></span>
              </div>
            </div>
            ...
            <div class="c-dashboardInfo col-xl-3 col-md-6">
              <div class="wrap">
                ...
                <span class='hind-font caption-12 text-white c-dashboardInfo__count'><?php echo $data6["total_claimed"] ?></span>
              </div>
            </div>
            ...
            <div class="c-dashboardInfo col-xl-3 col-md-6">
              <div class="wrap">
                ...
                <span class='hind-font caption-12 text-white c-dashboardInfo__count'><?php echo $data7["total_pending"] != 0 ? $data7["total_pending"] : "0"; ?></span>
              </div>
            </div>
            ...
            <div class="c-dashboardInfo col-xl-3 col-md-6">
              <div class="wrap">
                ...
                <span class='hind-font caption-12 text-white c-dashboardInfo__count'><?php echo $data8["total_claim"] ?></span>
              </div>
            </div>
    ...
    <div class="card">
          <div class="card-header bg-danger pt-3">
              <div class="text-center">
                  <p class="card-title text-light">Monthly Sales Graph</p>
              </div>
          </div>
