        ...
        if(fName && lName && address && contact) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response === "empty") {
                        swal("Empty Fields!", "Current Password or New Password are empty!");
                    } else if(response === "invalid") {
                        swal("Invalid Password!", "Invalid current Password!");
                    } else if(response === "empty1") {
                        swal("Empty Fields!", "Please make sure other fields are filled!");
