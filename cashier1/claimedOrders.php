      ...
      <main>
        <div class="container-fluid px-4">
          ...
          <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active mt-5">Sales</li>
          </ol>
          <div class="card mb-5">
            <div class="card-header bg-success pt-3">
              <div class="text-center">
                <p class="card-title text-light">Success Orders</p>
              </div>
            </div>
            <div class="card-body">
              <table id="residenceAccounts" class="table table-striped nowrap" style="width:100%">
                ...
                <tbody>
                  ...
                  $query = "SELECT tc.item_id, tc.account_id, tc.prod_id, tc.prod_qnty, 
                            ...
                            ta.contact, ta.address, tc.receiver, tc.sender
                            FROM tbl_cart tc 
                  ...
                  <div class="modal fade" id="residenceAccountDetails<?php echo htmlspecialchars($data["item_id"]); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
