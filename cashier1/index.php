      ...
      <div id="layoutSidenav_content">
        <main>
            ...
            <div class="c-dashboardInfo col-xl-3 col-md-6">
              <div class="wrap">
                <h4
                  class="heading heading5 hind-font medium-font-weight c-dashboardInfo__title text-white"
                >
                <?php
                ...
                <span class='hind-font caption-12 c-dashboardInfo__count text-white'>₱<?php echo $data5["total_sales"] != 0 ? number_format($data5["total_sales"], 2) : "0"; ?></span>
              </div>
            </div>
            ...
            <div class="c-dashboardInfo col-xl-3 col-md-6">
              <div class="wrap">
                ...
                <span class='hind-font caption-12 c-dashboardInfo__count text-white'><?php echo $data6["total_claimed"] ?></span>
              </div>
            </div>
            ...
            <div class="c-dashboardInfo col-xl-3 col-md-6">
              <div class="wrap">
                ...
                <span class='hind-font caption-12 c-dashboardInfo__count text-white'><?php echo $data7["total_pending"] != 0 ? $data7["total_pending"] : "0"; ?></span>
              </div>
            </div>
            ...
            <div class="c-dashboardInfo col-xl-3 col-md-6">
              <div class="wrap">
                ...
                <span class='hind-font caption-12 c-dashboardInfo__count text-white'><?php echo $data8["total_claim"] ?></span>
              </div>
            </div>
</div>
